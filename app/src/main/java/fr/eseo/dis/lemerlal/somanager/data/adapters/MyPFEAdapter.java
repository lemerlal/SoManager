...
public class MyPFEAdapter extends RecyclerView.Adapter<MyPFEAdapter.PFEViewHolder>{

    private MyPFEActivity activity;

    private List<Projects> projects;

    private List<Integer> positionsExpanded;

    public MyPFEAdapter(MyPFEActivity pfeActivity){
