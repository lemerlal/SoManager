...
public class MyProjetJuryDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        project = (Projects) data.getParcelable(MyJuriesDetailsActivity.PROJECT_EXTRA);
        ...
        poster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyProjetJuryDetailsActivity.this, PosterActivity.class);
    ...
    private void loadProjectDetails(){
        ...
        for(Students students : SoManagerDatabase.getDatabase(MyProjetJuryDetailsActivity.this).studentsDao().findAllStudents()){
