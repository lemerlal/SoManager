...
import fr.eseo.dis.lemerlal.somanager.MyJuriesActivity;
...
public class MyJuriesAdapter extends RecyclerView.Adapter<MyJuriesAdapter.JuriesViewHolder>{
    ...
    public MyJuriesAdapter(MyJuriesActivity JuriesActivity){
